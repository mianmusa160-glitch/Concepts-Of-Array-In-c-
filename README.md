...
<ol>All elements in an array must be of the same data type
Memory is allocated contiguously
Each element is accessed using an index
Array size is usually fixed at the time of declaration
Arrays provide fast access to elements</ol>
...
<b>Visual:</b> A spreadsheet or a grid.
...
<b>Visual:</b> A Rubik's cube or a stack of spreadsheets.
